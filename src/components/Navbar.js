      ...
      <div>
        <nav ng-class="hide-on-small-only">
          <ul className="side-nav fixed section table-of-contents">
            ...
            <li className="bold"><a aria-label="Open Andrew's resume in a new tab" href="#" className="waves-effect waves-dark grey-text text-darken-3"><i className="mdi-action-description small" /><span>Resume</span></a></li>
          </ul>
        </nav>
        <nav className="hide-on-large only trigger z-depth-1"><a aria-label="Toggle visibility of the mobile navbar" href="#" data-activates="slide-out" className="button-collapse"><i className="mdi-navigation-menu" /></a>
          <div className="name-title"><Link id="name" aria-label="Navigate to the beginning of the page" to="/" className="teal-text">Aayush Dutt</Link><span className="brown-text light">Full Stack Developer</span></div>
        </nav>
